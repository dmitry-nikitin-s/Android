package ru.mirea.nikitinds.thread;
...
import ru.mirea.nikitinds.thread.databinding.ActivityMainBinding;
            ...
            public void onClick(View v) {
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        mainThread.setName("МОЙ НОМЕР ГРУППЫ: БИСО-02-19, НОМЕР ПО СПИСКУ: 9, МОЙ ЛЮБИМЫЙ ФИЛЬМ: 'Горько 2'");
